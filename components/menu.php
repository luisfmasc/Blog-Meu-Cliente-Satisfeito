<nav class="navbar navbar-expand-lg navbar-light bg-light">
	<div class="container">
			<a class="navbar-brand" href="https://meuclientesatisfeito.com/" onClick="gtag('event', 'logo', {'event_category' : 'header', event_label' : 'clickLogotipo'})"><img class="img-responsive" src="../../images/logotipoClienteSatisfeito.png" height="80px" alt="Logotipo da Meu Cliente Satisfeito"></a>
