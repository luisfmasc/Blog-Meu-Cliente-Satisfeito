		<nav class="navbar navbar-default">
		  <div class="container"> 
			<div class="navbar-header">
			  ...
			  <a class="navbar-brand" href="../index.php" onClick="gtag('event', 'logo', {'event_category' : 'header', event_label' : 'clickLogotipo'})"><img class="img-responsive" src="images/logotipoClienteSatisfeito.png" alt="Logotipo da Meu Cliente Satisfeito"></a></div>
